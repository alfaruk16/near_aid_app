...
fun PhoneScreen(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        Column(
            ...
            Text(stringResource(Res.string.phone_title), style = MaterialTheme.typography.headlineMedium, modifier = Modifier.headingSemantics())
            Text(
            ...
            NearAidButton(
                text = stringResource(Res.string.phone_send_code),
                onClick = { viewModel.onIntent(PhoneIntent.Submit) },
                enabled = state.canSubmit,
                loading = state.loading,
            )
            Text(
                stringResource(Res.string.phone_terms),
