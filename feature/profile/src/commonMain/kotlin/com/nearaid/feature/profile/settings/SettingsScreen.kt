...
fun SettingsScreen(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        NearAidTopBar(title = stringResource(Res.string.settings_title), onBack = { viewModel.onIntent(SettingsIntent.BackClicked) })
        ...
        Column(
            ...
            SectionLabel(stringResource(Res.string.settings_language_label))

            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                NearAidChip(
                    label = stringResource(Res.string.settings_language_bn),
