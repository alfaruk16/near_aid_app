 ...
 * it (foreground) — this sidesteps every background-BLE restriction, especially on iOS.
 *
 * Implementations are platform-specific and bound into Koin via [com.nearaid.core.proximity.di.proximityModule].
 */
