...
data class HandoffToken(val claimId: String) {
    ...
    /**
     * A stable 4-byte code derived from [claimId]. Uses FNV-1a (a fixed, well-defined hash) rather
     * than [String.hashCode] so the value is deterministic regardless of any runtime differences.
     */
